classdef LinkComponentTest < matlab.unittest.TestCase
    % The test locks down the "Link" block behavior. The test 
    % sets up a test harness model with the Link block 
